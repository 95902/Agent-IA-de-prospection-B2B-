    ...
    <div className="w-full h-full flex flex-col gap-4">
      ...
      <div className="flex flex-1 flex-col w-full min-h-0 gap-4">
        <div className="flex h-2/5 w-full gap-4">
          <div className="px-8 py-6 w-1/3 bg-white rounded-lg border-2 min-w-md gap-6 flex flex-col overflow-hidden">
          ...
          <div className="px-8 py-6 w-2/3 bg-white rounded-lg border-2 min-w-md gap-6 flex flex-col overflow-hidden">
        ...
        <div className="py-4 px-8 h-1.5/5 w-full bg-white rounded-lg border-2 min-w-md gap-4 flex flex-col overflow-hidden">
          <div className="flex gap-2 items-center ">
          ...
          <div className="flex-1 min-w-md flex justify-between gap-4">
            <div className="w-full h-full flex-col px-4 py-2 justify-between flex bg-gray-100 rounded-lg border overflow-hidden">
            ...
            <div className="w-full h-full flex-col gap-2 px-4 py-2 justify-between flex bg-gray-100 rounded-lg border overflow-hidden">
            ...
            <div className="w-full h-full flex-col px-4 py-2 gap-2 flex bg-gray-100 rounded-lg border overflow-hidden">
        ...
        <div className="flex h-1.5/5 w-full gap-4">
          <div className="py-4 px-8 w-1/2 bg-gray-100 rounded-lg border-2 min-w-md  flex flex-col overflow-hidden">
            <div className="flex gap-2 items-center ">
          ...
          <div className="p-8 w-1/2 bg-white rounded-lg border-2 min-w-md gap-8 flex overflow-hidden">
        ...
        <FieldSet className="flex-1 flex flex-col min-h-0">
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4 flex-1 min-h-0">
            <Field className="row-span-2 flex flex-col h-full min-h-0">
              ...
              <div className="flex w-full border rounded-lg bg-white gap-4 p-2">
                <InfoIcon />
                <div className="flex flex-col gap-1">
                  <p className="">New feature available</p>
        ...
        <FieldSet>
          ...
          <FieldGroup>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-6 bg-white h-full shrink-0 rounded-lg border-2 flex-1 flex flex-col overflow-hidden">
